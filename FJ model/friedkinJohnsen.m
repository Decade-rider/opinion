...
% Run preprocessGraph to obtain equilibrium and the condition number
[N, A, B, equilibrium, cond_eye_A_B] = preprocessGraph(A, s);

% Display the condition number
disp(['Condition number of (eye(N) - (A - B)): ', num2str(cond_eye_A_B)]);
